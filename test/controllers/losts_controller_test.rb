...
class LostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lost" do
    assert_difference("Lost.count") do
      post losts_url, params: { lost: { description: @lost.description, pro: @lost.pro, thumbnail_url: @lost.thumbnail_url, title: @lost.title, video_url: @lost.video_url } }
    end
  ...
  test "should update lost" do
    patch lost_url(@lost), params: { lost: { description: @lost.description, pro: @lost.pro, thumbnail_url: @lost.thumbnail_url, title: @lost.title, video_url: @lost.video_url } }
